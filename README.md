...
![alt text](<registration page-1.png>) ![alt text](<login page-1.png>) ![alt text](<dashboard page.png>) ![alt text](<quiz page-1.png>) ![alt text](<ai chats page-1.png>) ![alt text](<study plan page-1.png>) ![alt text](<performance page-1.png>) ![alt text](<profile page-1.png>)  
